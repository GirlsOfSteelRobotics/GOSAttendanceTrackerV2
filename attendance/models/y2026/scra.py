...
class ScraVisitor2026(models.Model, InOutTimeMixin):
    ...
    def _get_attendance_set(self):
        return self.scravisitorattendance2026_set

    def _log_in(self):
        return ScraVisitorAttendance2026.objects.create(
...
class ScraVisitorAttendance2026(AttendanceMixin):
    scra_visitor = models.ForeignKey(ScraVisitor2026, on_delete=models.CASCADE)
